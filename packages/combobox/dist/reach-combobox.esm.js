import { forwardRef, useRef, createElement, useContext, useState, useEffect, useCallback, useMemo, Fragment, useReducer } from 'react';
...
function useReducerMachine(chart, reducer, initialData) {
  var _React$useState2 = useState(chart.initial),
