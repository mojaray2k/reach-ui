...
function getDocumentDimensions(element) {
  ...
  var ownerDocument =
    ownerDocument_dist_reachUtilsOwnerDocument.getOwnerDocument(element);
  ...
  return {
    width:
      (_ownerDocument$docume = ownerDocument.documentElement.clientWidth) !=
      null
        ? _ownerDocument$docume
        : ownerWindow.innerWidth,
    height:
      (_ownerDocument$docume2 = ownerDocument.documentElement.clientHeight) !=
      null
        ? _ownerDocument$docume2
