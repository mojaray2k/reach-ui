...
function getComputedStyles(element) {
  var ownerWindow =
    ownerDocument_dist_reachUtilsOwnerDocument.getOwnerWindow(element);
...
function getComputedStyle(element, styleProp) {
  ...
  return (
    ((_getComputedStyles = getComputedStyles(element)) == null
      ? void 0
      : _getComputedStyles.getPropertyValue(styleProp)) || null
  );
}
