...
var SliderInput = /*#__PURE__*/React.forwardRef(function SliderInput(_ref2, forwardedRef) {
  ...
  process.env.NODE_ENV !== "production" ? warning__default['default'](!DEPRECATED_getValueText, "The `getValueText` prop in @reach/slider is deprecated. Please use `getAriaValueText` instead.") : void 0;
...
if (process.env.NODE_ENV !== "production") {
  ...
  SliderInput.propTypes = /*#__PURE__*/_extends({}, sliderPropTypes, {
    children: /*#__PURE__*/PropTypes__default['default'].oneOfType([PropTypes__default['default'].node, PropTypes__default['default'].func]).isRequired
  });
} ////////////////////////////////////////////////////////////////////////////////
...
var SliderTrackHighlightImpl = /*#__PURE__*/React.forwardRef(function SliderTrackHighlightImpl(props, ref) {
  if (process.env.NODE_ENV !== "production") {
    ...
    React.useEffect(function () {
      process.env.NODE_ENV !== "production" ? warning__default['default'](false, "`SliderTrackHighlight` has been deprecated in favor of `SliderRange` and will be dropped from a future version of Reach UI.") : void 0;
    }, []);
  }
